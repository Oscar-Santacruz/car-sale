  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-gray-100 focus:!text-black dark:focus:bg-gray-800 dark:focus:!text-white",
        "data-[state=checked]:bg-gray-100 data-[state=checked]:!text-black dark:data-[state=checked]:bg-gray-800 dark:data-[state=checked]:!text-white",
